...
import ru.sfedu.deals.lab5.provider.NativeSQLProvider;

public class NativeSqlTests extends Tests {
  private static final IProvider provider = new NativeSQLProvider();
